...
do
    ...
    do
        ...
        #python together.py poletti2010/exp1/cond2/ ${a}_8_pi_arc/ ${i} exp1_cond2
        
        python together.py poletti2010/exp1/cond2/ ${a}_8_pi_arc/ ${i} exp1_cond2 
        python together.py poletti2010/exp1/cond2_light/ ${a}_8_pi_arc/ ${i} exp1_cond2_light
        python together.py poletti2010/exp1/cond4/ ${a}_8_pi_arc/ ${i} exp1_cond4
        python together.py poletti2010/exp2/cond2/ ${a}_8_pi_arc/ ${i} exp2_cond2 
        python together.py poletti2010/exp2/cond4/ ${a}_8_pi_arc/ ${i} exp2_cond4
        python together.py poletti2010/exp2/cond6/ ${a}_8_pi_arc/ ${i} exp2_cond6 
        python together.py poletti2010/exp2/cond8/ ${a}_8_pi_arc/ ${i} exp2_cond8
...
do
    ...
    do
        ...
        python together.py poletti2010/exp1/cond4_light/ ${a}_8_pi_arc/ ${i} exp1_cond4_light
        python together.py poletti2010/exp2/cond7/ ${a}_8_pi_arc/ ${i} exp2_cond7
...
do
    date
    python together.py poletti2010/exp1/cond1/ ${i} exp1_cond1_${i} 
    python together.py poletti2010/exp1/cond1_light/ ${i} exp1_cond1_light_${i}
    python together.py poletti2010/exp1/cond3/ ${i} exp1_cond3_${i} 
    python together.py poletti2010/exp1/cond3_light/ ${i} exp1_cond3_light_${i}
    python together.py poletti2010/exp2/cond1/ ${i} exp2_cond1_${i} 
    python together.py poletti2010/exp2/cond3/ ${i} exp2_cond3_${i} 
    python together.py poletti2010/exp2/cond5/ ${i} exp2_cond5_${i}
    date
