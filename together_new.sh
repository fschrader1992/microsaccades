...
do
    ...
    do
        ...
        python together_new.py poletti2010/exp1/cond2/ ${a}_8_pi_arc ${i} exp1_cond2 1 2
        python together_new.py poletti2010/exp1/cond2_light/ ${a}_8_pi_arc ${i} exp1_cond2_light 1 2_light
        python together_new.py poletti2010/exp1/cond4/ ${a}_8_pi_arc ${i} exp1_cond4 1 4
        python together_new.py poletti2010/exp2/cond2/ ${a}_8_pi_arc ${i} exp2_cond2 2 2
        python together_new.py poletti2010/exp2/cond4/ ${a}_8_pi_arc ${i} exp2_cond4 2 4
        python together_new.py poletti2010/exp2/cond6/ ${a}_8_pi_arc ${i} exp2_cond6 2 6
        python together_new.py poletti2010/exp2/cond8/ ${a}_8_pi_arc ${i} exp2_cond8 2 8
...
do
    ...
    do
        ...
        python together_new.py poletti2010/exp1/cond4_light/ ${a}_8_pi_arc ${i} exp1_cond4_light 1 4_light
        python together_new.py poletti2010/exp2/cond7/ ${a}_8_pi_arc ${i} exp2_cond7 2 7
...
do
    date
    python together_new.py poletti2010/exp1/cond1/ ${i} exp1_cond1_${i} 1 1
    python together_new.py poletti2010/exp1/cond1_light/ ${i} exp1_cond1_light_${i} 1 1_light
    python together_new.py poletti2010/exp1/cond3/ ${i} exp1_cond3 1 3
    python together_new.py poletti2010/exp1/cond3_light/ ${i} exp1_cond3_light_${i} 1 3_light
    python together_new.py poletti2010/exp2/cond1/ ${i} exp2_cond1_${i} 2 1
    python together_new.py poletti2010/exp2/cond3/ ${i} exp2_cond3_${i} 2 3
    python together_new.py poletti2010/exp2/cond5/ ${i} exp2_cond5 2 5
    date
