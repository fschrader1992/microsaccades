...
r = open('/home/schrader/Documents/microsaccades/data/'+str(sim_title)+'/jitter_p_corr_max_spikes_mdw_all_'+str(fh)+'.txt','w+')
r2 = open('/home/schrader/Documents/microsaccades/data/jitter/jitter_p_corr_max_spikes_mdw_all.txt','a+')
f = open('/home/schrader/Documents/microsaccades/data/'+str(sim_title)+str(sim_title_2)+'network/'+str(sim_nr)+'/p_spikes_.txt','r+')
for line in f:
    ltw = line
r.write(ltw)
r2.write(ltw)
